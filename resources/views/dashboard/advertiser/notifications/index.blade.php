...
@section('title', 'Notifications - Advertiser Dashboard')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form method="GET" action="{{ route('dashboard.advertiser.notifications.index') }}">
                <div class="filter-form-row">
                    <div class="filter-field">
                        ...
                        <select name="category" class="form-control">
                            ...
                            <option value="user" {{ request('category') == 'user' ? 'selected' : '' }}>Account</option>
                        </select>
                    </div>
                    <div class="filter-field">
                ...
                <div class="filter-buttons">
                    ...
                    <a href="{{ route('dashboard.advertiser.notifications.index') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="header-actions">
                <form action="{{ route('dashboard.advertiser.notifications.mark-all-read') }}" method="POST" style="display: inline;">
                    @csrf
                            ...
                            <tr class="{{ $notification->is_read ? '' : 'notification-unread' }}">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        @if(!$notification->is_read)
                                            <form action="{{ route('dashboard.advertiser.notifications.mark-read', $notification->id) }}" method="POST" class="action-form">
                                                @csrf
                                        ...
                                        @else
                                            <form action="{{ route('dashboard.advertiser.notifications.mark-unread', $notification->id) }}" method="POST" class="action-form">
                                                @csrf

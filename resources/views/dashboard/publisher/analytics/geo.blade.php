...
@section('title', 'Geo Analytics - Publisher Dashboard')
...
@section('content')
    <div class="page-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1>Geo Analytics</h1>
                <p class="text-muted">View earnings performance by country.</p>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="GET" action="{{ route('dashboard.publisher.analytics.geo') }}">
                ...
                <div style="display: flex; justify-content: flex-end; gap: 10px;">
                    ...
                    <a href="{{ route('dashboard.publisher.analytics.geo') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Earnings Performance by Country</h3>
        </div>
        <div class="card-body">
            @if($geoStats->count() > 0)

...
@section('title', 'Geo Analytics - Advertiser Dashboard')
...
@section('content')
    <div class="page-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <h1>Geo Analytics</h1>
                <p class="text-muted">View campaign performance by country.</p>
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <form method="GET" action="{{ route('dashboard.advertiser.analytics.geo') }}">
                ...
                <div style="display: flex; justify-content: flex-end; gap: 10px;">
                    ...
                    <a href="{{ route('dashboard.advertiser.analytics.geo') }}" class="btn btn-secondary">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Campaign Performance by Country</h3>
        </div>
        <div class="card-body">
            @if($geoStats->count() > 0)

...
@section('title', 'Edit Announcement - Admin Dashboard')
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.admin.announcements.update', $announcement) }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="target_audience" name="target_audience" class="form-control @error('target_audience') is-invalid @enderror" required>
                                ...
                                <option value="publishers" {{ old('target_audience', $announcement->target_audience) == 'publishers' ? 'selected' : '' }}>Publishers Only</option>
                                <option value="advertisers" {{ old('target_audience', $announcement->target_audience) == 'advertisers' ? 'selected' : '' }}>Advertisers Only</option>

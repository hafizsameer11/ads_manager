...
@section('title', 'Abuse Report - Admin Dashboard')
    ...
    <div class="message-detail-card">
        <div class="message-header">
            ...
            <div class="message-meta">
                ...
                @if($report->url)
                    <div class="meta-item">
                        <div class="meta-label">Reported URL</div>
                        <div class="meta-value">
        ...
        <div class="message-body">
            <h3>Description</h3>
            <div class="message-content">{{ $report->description }}</div>
        </div>
        ...
        <div class="status-form">
            ...
            <form action="{{ route('dashboard.admin.abuse-reports.update-status', $report->id) }}" method="POST">
                @csrf
        ...
        <div class="message-actions">
            <a href="{{ route('dashboard.admin.abuse-reports') }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Back to Reports
            </a>
            <a href="mailto:{{ $report->email }}?subject=Re: Abuse Report #{{ $report->id }}" class="btn btn-primary">
                <i class="fas fa-reply"></i> Reply
            </a>
            <form action="{{ route('dashboard.admin.abuse-reports.destroy', $report->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this report? This action cannot be undone.');">
                @csrf
                @method('DELETE')

...
@section('title', 'Edit Ad Unit - Admin Dashboard')

@section('content')
    <div style="display: flex; justify-content: flex-end; gap: 10px; margin-bottom: 20px;">
        <a href="{{ route('dashboard.admin.ad-units.show', $adUnit->id) }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Back to Ad Unit
        </a>
        <a href="{{ route('dashboard.admin.ad-units') }}" class="btn btn-secondary">
            <i class="fas fa-list"></i> All Ad Units
        </a>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.admin.ad-units.update', $adUnit->id) }}">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select id="publisher_id" name="publisher_id" class="form-control" required onchange="updateWebsites()">
                                ...
                                @foreach($publishers as $publisher)
                                    <option value="{{ $publisher->id }}" {{ old('publisher_id', $adUnit->publisher_id) == $publisher->id ? 'selected' : '' }}>
                            ...
                            <select id="website_id" name="website_id" class="form-control" required>
                                ...
                                @foreach($websites as $website)
                                    <option value="{{ $website->id }}" 
                                            ...
                                            {{ old('website_id', $adUnit->website_id) == $website->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select id="type" name="type" class="form-control" required onchange="toggleFields()">
                                <option value="banner" {{ old('type', $adUnit->type) == 'banner' ? 'selected' : '' }}>Banner</option>
                                <option value="popup" {{ old('type', $adUnit->type) == 'popup' ? 'selected' : '' }}>Popup</option>
                            </select>
                ...
                <!-- Banner Fields -->
                <div id="bannerFields" style="display: {{ $adUnit->type === 'banner' ? 'block' : 'none' }};">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="size" name="size" class="form-control" 
                                       ...
                                       pattern="\d+x\d+" {{ $adUnit->type === 'banner' ? 'required' : '' }}>
                ...
                <!-- Popup Fields -->
                <div id="popupFields" style="display: {{ $adUnit->type === 'popup' ? 'block' : 'none' }};">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="frequency" name="frequency" class="form-control" 
                                       ...
                                       min="1" max="3600" {{ $adUnit->type === 'popup' ? 'required' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input type="checkbox" id="is_anti_adblock" name="is_anti_adblock" class="form-check-input" value="1" {{ old('is_anti_adblock', $adUnit->is_anti_adblock) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="cpm_rate" name="cpm_rate" class="form-control" 
                                   value="{{ old('cpm_rate', $adUnit->cpm_rate) }}" step="0.0001" min="0">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" id="cpc_rate" name="cpc_rate" class="form-control" 
                                   value="{{ old('cpc_rate', $adUnit->cpc_rate) }}" step="0.0001" min="0">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="alert alert-info">
                            <strong>Note:</strong> Unit code is automatically generated and cannot be modified.
                        </div>
                    </div>
                </div>

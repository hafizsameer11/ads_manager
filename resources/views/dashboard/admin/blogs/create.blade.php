            ...
            <form method="POST" action="{{ route('dashboard.admin.blogs.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    @error('featured_image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text text-muted">Recommended size: 1200x630px. Max size: 5MB. Formats: JPEG, PNG, GIF, WebP</small>
                ...
                <div class="form-group">
                    ...
                    <div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="status" id="status_draft" value="draft" {{ old('status', 'draft') === 'draft' ? 'checked' : '' }} required>

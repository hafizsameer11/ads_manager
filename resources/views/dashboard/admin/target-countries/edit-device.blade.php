...
@section('title', 'Edit Target Device - Admin Dashboard')

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Target Device</h3>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('dashboard.admin.target-countries.update-device', $targetDevice->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $targetDevice->name) }}" required placeholder="e.g., Desktop, Mobile, Tablet">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="is_enabled" value="1" {{ old('is_enabled', $targetDevice->is_enabled) ? 'checked' : '' }}>
                                Enable this device
                            </label>

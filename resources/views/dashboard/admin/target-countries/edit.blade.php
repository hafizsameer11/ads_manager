...
@section('title', 'Edit Target Country - Admin Dashboard')

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Target Country</h3>
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('dashboard.admin.target-countries.update', $targetCountry->id) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control" value="{{ old('name', $targetCountry->name) }}" required placeholder="e.g., United States">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="code" name="code" class="form-control" value="{{ old('code', $targetCountry->code) }}" required placeholder="e.g., US" maxlength="2" style="text-transform: uppercase;">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>
                                <input type="checkbox" name="is_enabled" value="1" {{ old('is_enabled', $targetCountry->is_enabled) ? 'checked' : '' }}>
                                Enable this country
                            </label>
